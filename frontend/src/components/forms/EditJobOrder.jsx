...
export default function EditJobOrder({ jobOrderId, onClose, onSuccess }) {
  ...
  // Track materials length changes and clean up lockedMaterialIds when materials are removed
  useEffect(() => {
  ...
  // Keep activeMaterialIndex in valid range when selectedMaterials changes (e.g. on load)
  useEffect(() => {
