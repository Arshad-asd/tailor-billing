...
export default function EditPurchaseModal({ open, onClose, onSubmit, editingPurchase = null }) {
  ...
  useEffect(() => {
    if (editingPurchase) {
      setForm({
        ...
        totalAmount: editingPurchase.totalAmount?.toString() || "",
        orderDate: editingPurchase.orderDate || "",
        expectedDelivery: editingPurchase.expectedDelivery || "",
  ...
  const handleSubmit = (e) => {
    ...
    onSubmit(formData, editingPurchase?.id);
  };
