...
import { Eye, EyeOff, Mail, Lock, ArrowLeft, ChefHat } from 'lucide-react';
...
const RestaurantLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // For demo purposes, redirect to restaurant dashboard
      navigate('/restaurant');
    } catch (err) {
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          <div className="mt-4 p-4 bg-gray-50 rounded-lg">
            ...
            <p className="text-xs text-gray-500">Email: restaurant@demo.com</p>
